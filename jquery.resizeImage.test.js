		...
		( function( $ ){
			...
			$.fn != undefined ? $.fn.resizeImage = core : console.log('JQuery 2.0.0 undefined')
								...
								Scaler( originDetails, ADAPTED, function( SCALED ){
										...
										// Static canvas zooming informations
											...
											$('#move-stats').html( '<h3>Initialize</h3>'
																					...
																					+'<small>SCALED.width: '+ SCALED.width +'<br>SCALED.height: '+ SCALED.height +'</small><br>' 
																					+'<small>SCALED.left: '+ SCALED.left +'<br>SCALED.top: '+ SCALED.top +'</small><br><br>' 
										...
										function resizing( e, RESIZING, touch ){
											...
											$('#move-stats').html( '<h3>Resizing</h3>'
																					...
																					+'<small>Min resize Scaler sizes: '+ MIN_WIDTH +'x'+ MIN_HEIGHT +'</small><br><br>' 
																					
																					+'<small>ZOOMING.width: '+ ZOOMING.width +' >> '+ ADAPTED.width +'<br>ZOOMING.height: '+ ZOOMING.height +' >> '+ ADAPTED.height +'</small><br>' 
																					+'<small>ZOOMING.left: '+ ZOOMING.left +' >> '+ ADAPTED.left +'<br>ZOOMING.top: '+ ZOOMING.top +' >> '+ ADAPTED.top +'</small><br><br>' 
																					
																					+'<small>SCALER.width: '+ SC_WIDTH +' >> '+ ADAPTED.width +'<br>SCALER.height: '+ SC_HEIGHT +' >> '+ ADAPTED.height +'</small><br>' 
																					+'<small>SCALER.top: '+( TOP )+'<br>SCALER.left: '+( LEFT )+'</small><br><br>'
